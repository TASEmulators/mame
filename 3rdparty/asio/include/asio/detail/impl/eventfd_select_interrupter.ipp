...
#include <sys/types.h>
#include <fcntl.h>
#if !defined(MAME_WATERBOX) && __GLIBC__ == 2 && __GLIBC_MINOR__ < 8 && !defined(__UCLIBC__)
# include <asm/unistd.h>
#else // !defined(MAME_WATERBOX) && __GLIBC__ == 2 && __GLIBC_MINOR__ < 8 && !defined(__UCLIBC__)
# include <sys/eventfd.h>
#endif // !defined(MAME_WATERBOX) && __GLIBC__ == 2 && __GLIBC_MINOR__ < 8 && !defined(__UCLIBC__)
